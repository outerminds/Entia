    ...
    public static class Test
    {
        ...
        public static void Run(int count = 1600, int size = 1600)
        {
            ...
            var generator = Generator.Frequency(
                ...
                (2, Gen.Fresh(() => new CloneComponent<ComponentB>().ToAction())),
                (2, Gen.Fresh(() => new CloneComponent<ComponentC<Unit>>().ToAction())),
                (2, Gen.Fresh(() => new CloneComponent<IComponentA>().ToAction())),
                (2, Gen.Fresh(() => new CloneComponent<IComponentB>().ToAction())),
                (2, Gen.Fresh(() => new CloneComponent<IComponentC>().ToAction())),
                (2, Gen.Fresh(() => new CloneComponent<IComponent>().ToAction())),
                (2, Gen.Fresh(() => new CloneComponent(typeof(ComponentB)).ToAction())),
                (2, Gen.Fresh(() => new CloneComponent(typeof(ComponentC<>)).ToAction())),
                (2, Gen.Fresh(() => new CloneComponent(typeof(IComponentC)).ToAction())),
                (2, Gen.Fresh(() => new CloneComponent(typeof(IComponent)).ToAction())),

                (5, Gen.Fresh(() => new CopyComponents().ToAction())),
