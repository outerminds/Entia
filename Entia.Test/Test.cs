    ...
    public static class Test
    {
        ...
        public static void Run(int count = 1600, int size = 1600)
        {
            ...
            var generator = Generator.Frequency(
                ...
                (4, Gen.Fresh(() => new CloneComponents(Depth.Shallow).ToAction())),
                (4, Gen.Fresh(() => new CloneComponents(Depth.Deep).ToAction())),
                (2, Gen.Fresh(() => new CloneComponent<ComponentA>(Depth.Shallow).ToAction())),
                (2, Gen.Fresh(() => new CloneComponent<ComponentB>(Depth.Deep).ToAction())),
                (2, Gen.Fresh(() => new CloneComponent<ComponentC<Unit>>().ToAction())),
                (2, Gen.Fresh(() => new CloneComponent<IComponentA>(Depth.Shallow).ToAction())),
                (2, Gen.Fresh(() => new CloneComponent<IComponentB>(Depth.Deep).ToAction())),
                (2, Gen.Fresh(() => new CloneComponent<IComponentC>(Depth.Shallow).ToAction())),
                (2, Gen.Fresh(() => new CloneComponent<IComponent>(Depth.Deep).ToAction())),
                (2, Gen.Fresh(() => new CloneComponent(typeof(ComponentB), Depth.Shallow).ToAction())),
                (2, Gen.Fresh(() => new CloneComponent(typeof(ComponentC<>), Depth.Deep).ToAction())),
                (2, Gen.Fresh(() => new CloneComponent(typeof(IComponentC), Depth.Shallow).ToAction())),
                (2, Gen.Fresh(() => new CloneComponent(typeof(IComponent), Depth.Deep).ToAction())),
