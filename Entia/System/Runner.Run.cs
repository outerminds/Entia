...
namespace Entia.Experimental
{
    public readonly partial struct Runner
    {
        ...
        public static partial class When<TReact>
        {
            ...
            public static Runner Run<T>(RunM<TReact, T> run) where T : struct, IResource =>
            ...
            public static Runner Run<T1, T2>(RunM<TReact, T1, T2> run) where T1 : struct, IResource where T2 : struct, IResource =>
            ...
            public static Runner Run<T1, T2, T3>(RunM<TReact, T1, T2, T3> run) where T1 : struct, IResource where T2 : struct, IResource where T3 : struct, IResource =>
            ...
            public static Runner Run<T1, T2, T3, T4>(RunM<TReact, T1, T2, T3, T4> run) where T1 : struct, IResource where T2 : struct, IResource where T3 : struct, IResource where T4 : struct, IResource =>
            ...
            public static Runner Run<T1, T2, T3, T4, T5>(RunM<TReact, T1, T2, T3, T4, T5> run) where T1 : struct, IResource where T2 : struct, IResource where T3 : struct, IResource where T4 : struct, IResource where T5 : struct, IResource =>
        ...
        public static partial class When<TReact, TReceive>
        {
            ...
            public static Runner Run<T>(RunM<TReceive, T> run) where T : struct, IResource =>
                With((Resource<T> resource1) => Run((in TReact react, in TReceive receive) => run(receive, ref resource1.Value)));
            public static Runner Run<T>(RunMM<TReact, TReceive, T> run) where T : struct, IResource =>
            ...
            public static Runner Run<T1, T2>(RunM<TReceive, T1, T2> run) where T1 : struct, IResource where T2 : struct, IResource =>
            ...
            public static Runner Run<T1, T2>(RunMM<TReact, TReceive, T1, T2> run) where T1 : struct, IResource where T2 : struct, IResource =>
            ...
            public static Runner Run<T1, T2, T3>(RunM<TReceive, T1, T2, T3> run) where T1 : struct, IResource where T2 : struct, IResource where T3 : struct, IResource =>
            ...
            public static Runner Run<T1, T2, T3>(RunMM<TReact, TReceive, T1, T2, T3> run) where T1 : struct, IResource where T2 : struct, IResource where T3 : struct, IResource =>
            ...
            public static Runner Run<T1, T2, T3, T4>(RunM<TReceive, T1, T2, T3, T4> run) where T1 : struct, IResource where T2 : struct, IResource where T3 : struct, IResource where T4 : struct, IResource =>
            ...
            public static Runner Run<T1, T2, T3, T4>(RunMM<TReact, TReceive, T1, T2, T3, T4> run) where T1 : struct, IResource where T2 : struct, IResource where T3 : struct, IResource where T4 : struct, IResource =>
            ...
            public static Runner Run<T1, T2, T3, T4, T5>(RunM<TReceive, T1, T2, T3, T4, T5> run) where T1 : struct, IResource where T2 : struct, IResource where T3 : struct, IResource where T4 : struct, IResource where T5 : struct, IResource =>
            ...
            public static Runner Run<T1, T2, T3, T4, T5>(RunMM<TReact, TReceive, T1, T2, T3, T4, T5> run) where T1 : struct, IResource where T2 : struct, IResource where T3 : struct, IResource where T4 : struct, IResource where T5 : struct, IResource =>
