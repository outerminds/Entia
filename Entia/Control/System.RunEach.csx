IEnumerable<(string system, string scheduler, string depender)> Generate(int depth)
{
    ...
    for (int i = 0; i <= depth; i++)
    {
        ...
        yield return (
$@"    public interface IRunEach{parameters} : ISystem, IImplementation<Schedulers.RunEach{parameters}>, IImplementation<Dependers.RunEach{parameters}>{constraints}
    {{
