/* DO NOT MODIFY: The content of this file has been generated by the script 'System.RunEach.csx'. */
...
{
    public interface IRunEach : ISystem, IImplementation<Schedulers.RunEach>, IImplementation<Dependers.RunEach>
    {
        void Run(Entity entity);
    }
    public interface IRunEach<T> : ISystem, IImplementation<Schedulers.RunEach<T>>, IImplementation<Dependers.RunEach<T>> where T : struct, IComponent
    {
        void Run(Entity entity, ref T component1);
    }
    public interface IRunEach<T1, T2> : ISystem, IImplementation<Schedulers.RunEach<T1, T2>>, IImplementation<Dependers.RunEach<T1, T2>> where T1 : struct, IComponent where T2 : struct, IComponent
    {
        void Run(Entity entity, ref T1 component1, ref T2 component2);
    }
    public interface IRunEach<T1, T2, T3> : ISystem, IImplementation<Schedulers.RunEach<T1, T2, T3>>, IImplementation<Dependers.RunEach<T1, T2, T3>> where T1 : struct, IComponent where T2 : struct, IComponent where T3 : struct, IComponent
    {
        void Run(Entity entity, ref T1 component1, ref T2 component2, ref T3 component3);
    }
    public interface IRunEach<T1, T2, T3, T4> : ISystem, IImplementation<Schedulers.RunEach<T1, T2, T3, T4>>, IImplementation<Dependers.RunEach<T1, T2, T3, T4>> where T1 : struct, IComponent where T2 : struct, IComponent where T3 : struct, IComponent where T4 : struct, IComponent
    {
        void Run(Entity entity, ref T1 component1, ref T2 component2, ref T3 component3, ref T4 component4);
    }
    public interface IRunEach<T1, T2, T3, T4, T5> : ISystem, IImplementation<Schedulers.RunEach<T1, T2, T3, T4, T5>>, IImplementation<Dependers.RunEach<T1, T2, T3, T4, T5>> where T1 : struct, IComponent where T2 : struct, IComponent where T3 : struct, IComponent where T4 : struct, IComponent where T5 : struct, IComponent
    {
        void Run(Entity entity, ref T1 component1, ref T2 component2, ref T3 component3, ref T4 component4, ref T5 component5);
    }
    public interface IRunEach<T1, T2, T3, T4, T5, T6> : ISystem, IImplementation<Schedulers.RunEach<T1, T2, T3, T4, T5, T6>>, IImplementation<Dependers.RunEach<T1, T2, T3, T4, T5, T6>> where T1 : struct, IComponent where T2 : struct, IComponent where T3 : struct, IComponent where T4 : struct, IComponent where T5 : struct, IComponent where T6 : struct, IComponent
    {
    ...
    public interface IRunEach<T1, T2, T3, T4, T5, T6, T7> : ISystem, IImplementation<Schedulers.RunEach<T1, T2, T3, T4, T5, T6, T7>>, IImplementation<Dependers.RunEach<T1, T2, T3, T4, T5, T6, T7>> where T1 : struct, IComponent where T2 : struct, IComponent where T3 : struct, IComponent where T4 : struct, IComponent where T5 : struct, IComponent where T6 : struct, IComponent where T7 : struct, IComponent
    {
