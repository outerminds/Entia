...
{
    public interface IReact : IPhase { }
    ...
    public struct PreReact<T> : IReact where T : struct, IMessage { public T Message; }
    public struct PostReact<T> : IReact where T : struct, IMessage { public T Message; }
    public struct React<T> : IReact where T : struct, IMessage { public T Message; }
