...
{
    public interface IGroup_OLD
    {
        int Count { get; }
        IEnumerable<Entity> Entities { get; }

        IQuery_OLD Query { get; }
        Type Type { get; }
    ...
    public sealed class Group_OLD<T> : IGroup_OLD, IEnumerable<T> where T : struct, IQueryable
    {
        ...
        IQuery_OLD IGroup_OLD.Query => Query;
        Type IGroup_OLD.Type => typeof(T);
        ...
        public Group_OLD(Query_OLD<T> query, Entities entities)
        {
            Query = query;
            _entities = entities;
        }
