...
namespace Entia.Analyze
{
	public readonly struct Symbols
	{
		...
		public INamedTypeSymbol Tag => _tag.Value;
		readonly Lazy<INamedTypeSymbol> _tag;
		...
		public INamedTypeSymbol Segment => _segment.Value;
		readonly Lazy<INamedTypeSymbol> _segment;
