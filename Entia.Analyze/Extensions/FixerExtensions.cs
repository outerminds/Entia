...
namespace Entia.Analyze
{
	...
	{
		public static async Task RegisterCodeAction<T>(this CodeFixContext context, string name, string identifier, Func<Document, CompilationUnitSyntax, T, CancellationToken, Task<Solution>> action) where T : SyntaxNode
		{
